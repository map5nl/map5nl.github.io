...
This is the website for [www.map5.nl](http://www.map5.nl). Other than for website-authors not rather interesting.

Below some content as in the README of the Bootstrap template.
